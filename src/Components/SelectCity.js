...
function SelectCity(props) {
  const {darkMode, handleInputSubmit, changeTransparent, currentCity, handleInputChange} = props;
  return (
    <div className="select-city-container">
      <div className={`select-city-exit ${darkMode ? "select-city-exit-dark" : ""}`} onClick={changeTransparent}>X</div>
